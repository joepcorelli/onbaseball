class User
  ...
  # Notifications
  has_many :received_notifications, class_name: 'Notification', foreign_key: 'recipient_id', inverse_of: :recipient, dependent: :destroy
  ...
  def mark_notifications_as_read
    received_notifications.unread.update_all(read: true)
  end
